...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtview; //обхявление переменных и предание типа
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);//он запускается при создании приложения
...
//    public void scientific_operation(){
        ...
        stpower2nd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ValueOne = Float.parseFloat(txtview.getText() + "");//парсинг строк из текстового в числовое(float), парс поле ввода
                    istpower = true;
        ...
        epowerbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    float exp = (float) Math.pow(2.718281828, n);
                    String formattedDouble = String.format("%.5f", exp);
                    txtview.setText(formattedDouble);
                } catch (Throwable e){
                    Toast t = Toast.makeText(MainActivity.this, "Syntax ERROR", Toast.LENGTH_LONG);
                    t.setGravity(Gravity.CENTER, 0, 0);
                    t.show();
...
//                 txtbtn.setText(Math.PI + " ");
        ...
        equalbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {//кнопка равно, проверяет операцию, которая была вызвана
                try {
                    if (Sin == true) {
                        if (Arithmetic == true) {
                            String str;
                    ...
                    if (istpower == true) {
                        ...
                        float exp = (float) Math.pow(ValueOne, ValueTwo);
                        txtview.setText(exp + "");
                        istpower = false;
                    }
                    if (Addition == true) {
